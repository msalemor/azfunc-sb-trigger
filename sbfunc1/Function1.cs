...
namespace sbfunc1
{
    public static class Function1
    {
        ...
        public static async Task Run([ServiceBusTrigger("inputqueue", Connection = "SBConnection")]Message myQueueItem, ILogger log, MessageReceiver messageReceiver, ExecutionContext context)
        {
